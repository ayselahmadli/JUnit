package day07_testBase_dropdown;
...
public class C02_DropdownMenu extends TestBase {
    ...
    public void test01(){
        ...
        if (actualOptionSayisi == 28){
        System.out.println("The dropdown menu has 28 options.");
        } else {
        System.out.println("The dropdown menu does not have 28 options.");
       }
